...
import com.hutter.master.base.properties.DruidProperties;
...
@EnableJpaRepositories(
	basePackages = "com.hutter.master.data.repository", 
...
public class DruidAutoConfiguration {
	...
	public EntityManagerFactory entityManagerFactory() {
		...
		factory.setPackagesToScan("com.hutter.master.data.domain");
